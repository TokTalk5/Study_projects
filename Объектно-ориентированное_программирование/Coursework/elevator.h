...
class Elevator : public QObject
{
    ...
    void takePassangers();
    void takePassangers(int numPassangers);
...
public:
    ...
    // Добавляем объявление функции setInitialConditions
    void setInitialConditions(int startFloor, direction dir, int destFloor);

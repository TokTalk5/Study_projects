...
QT_MOC_LITERAL(4, 32, 4), // "send"
QT_MOC_LITERAL(5, 37, 23) // "processPendingDatagrams"

    },
    "TCommunicator\0recieved\0\0message\0send\0"
...
void TCommunicator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->recieved((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (TCommunicator::*)(const QString & );
...
// SIGNAL 0
void TCommunicator::recieved(const QString & _t1)
{
